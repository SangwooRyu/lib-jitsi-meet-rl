...
declare class JitsiConference {
     ...
     */
    startRandomSelection(initiator: any): void;
    /**
     *
     * @param {string} initiator
     * @param {string} remoteParticipantID
     */
    notifyBirthdayHatOn(initiator: string, remoteParticipantID: string): void;
    /**
     ...
     * */
    startTimer(initiator: any, endUNIXTime: any): void;
    /**
     ...
     * @param initiator one who initiates the message.
     * */
    stopTimer(initiator: any): void;
    /**
     * Function that is invoked to finalize the selection of participant from
     * random selection procedure.
     */
    finalizeRandomSelection(selectedParticipantDisplayName: any, randomParticipantID: any): void;
    /**
    ...
    recvVideoParticipants(participantIds: any): void;
    /**
    ...
    updateParticipantBirthdayHatFlag(id: any, hatOn: any): void;
     ...
     */
    ackMuteParticipant(jid: any, ack: any): void;
    /**
     * ack mutes a participant.
     * @param {string} id The id of the participant to toggle.
     */
    ackMuteParticipantVideo(jid: any, ack: any): void;
    /**
     ...
     * the same jwt.
     */
    onMemberJoined(jid: any, nick: any, role: any, isHidden: any, statsID: any, status: any, identity: any, botType: any, fullJid: any, features: any, bDate: any, hatOn: any, isReplaceParticipant: any): void;
     ...
     * @param {string} kind
     */
    enableAVModeration(kind: string): void;
    /**
     * Disables AV Moderation.
     * @param {string} kind
     */
    disableAVModeration(kind: string): void;
    /**
     ...
     * @param id the id of the participant.
     */
    avModerationApprove(kind: string, id: any): void;
    /**
     ...
     * @param id the id of the participant.
     */
    avModerationReject(kind: string, id: any): void;
    /**
