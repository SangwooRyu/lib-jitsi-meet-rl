...
export declare enum JitsiConferenceEvents {
    ...
    NOTIFY_RANDOM_SELECTION_STARTED = "conference.notify_random_selection_started",
    RANDOM_SELECTION_COUNTDOWN = "conference.random_selection_countdown",
    PIN_RANDOM_PARTICIPANT = "conference.pin_random_participant",
    NOTIFY_RANDOM_SELECTION_FINISHED = "conference.notify_random_selection_finished",
    PARTICIPANT_BIRTHDAY_FLAG_UPDATED = "conference.birthday_flag_updated",
    NOTIFY_TIMER_STARTED = "conference.notify_timer_started",
    NOTIFY_TIMER_FINISHED = "conference.notify_timer_finished",
    NOTIFY_BIRTHDAY_HAT_ON = "conference.notify_birthday_hat_on",
    NOTICE_MESSAGE = "conference.notice_message",
    /**
     * Event fired when the attention status was updated.
     */
    BREAKOUT_ROOMS_ATTENTION_UPDATED = "conference.breakout-rooms.attention-updated",
    /**
...
export declare const TIME_REMAINED = JitsiConferenceEvents.TIME_REMAINED;
export declare const NOTIFY_RANDOM_SELECTION_STARTED = JitsiConferenceEvents.NOTIFY_RANDOM_SELECTION_STARTED;
export declare const NOTIFY_RANDOM_SELECTION_FINISHED = JitsiConferenceEvents.NOTIFY_RANDOM_SELECTION_FINISHED;
export declare const RANDOM_SELECTION_COUNTDOWN = JitsiConferenceEvents.RANDOM_SELECTION_COUNTDOWN;
export declare const PIN_RANDOM_PARTICIPANT = JitsiConferenceEvents.PIN_RANDOM_PARTICIPANT;
export declare const PARTICIPANT_BIRTHDAY_FLAG_UPDATED = JitsiConferenceEvents.PARTICIPANT_BIRTHDAY_FLAG_UPDATED;
export declare const NOTIFY_TIMER_STARTED = JitsiConferenceEvents.NOTIFY_TIMER_STARTED;
export declare const NOTIFY_TIMER_FINISHED = JitsiConferenceEvents.NOTIFY_TIMER_FINISHED;
export declare const NOTIFY_BIRTHDAY_HAT_ON = JitsiConferenceEvents.NOTIFY_BIRTHDAY_HAT_ON;
