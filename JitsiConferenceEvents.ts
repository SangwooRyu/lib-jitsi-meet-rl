...
export const RANDOM_SELECTION_COUNTDOWN = JitsiConferenceEvents.RANDOM_SELECTION_COUNTDOWN;
export const PIN_RANDOM_PARTICIPANT = JitsiConferenceEvents.PIN_RANDOM_PARTICIPANT;
export const PARTICIPANT_BIRTHDAY_FLAG_UPDATED = JitsiConferenceEvents.PARTICIPANT_BIRTHDAY_FLAG_UPDATED;
export const NOTIFY_TIMER_STARTED = JitsiConferenceEvents.NOTIFY_TIMER_STARTED;
export const NOTIFY_TIMER_FINISHED = JitsiConferenceEvents.NOTIFY_TIMER_FINISHED;
export const NOTIFY_BIRTHDAY_HAT_ON = JitsiConferenceEvents.NOTIFY_BIRTHDAY_HAT_ON;
export const NOTICE_MESSAGE = JitsiConferenceEvents.NOTICE_MESSAGE;
